...
import { FaHome, FaClipboardCheck, FaLaptop, FaSignOutAlt } from 'react-icons/fa';
import logsIcon from '../assets/logs.svg';

export function InventSidebar() {
  ...
  return (
    <SidebarContainer>
      ...
      <NavItems>
        <NavItem
          active={location.pathname === '/inv/dashboard' || location.pathname === '/inv/dashboard'}
        ...
        {/* --- SECCIÓN DE REVISIONES (Reemplaza a Request HO) --- */}
        <NavItem
          active={location.pathname === '/inv/reviews'}
          onClick={() => navigate('/inv/reviews')}
        >
          <FaClipboardCheck />
          <Tooltip className="tooltip">Pending Reviews</Tooltip>
        </NavItem>
        ...
        <NavItem
          active={location.pathname === '/inv/logs'}
          onClick={() => navigate('/inv/logs')}
        >
          <NavIcon active={location.pathname === '/inv/logs'} src={logsIcon} alt="Logs" />
...
// --- ESTILOS (Se mantienen igual, solo ajusté NavIcon para usar SVGs de react-icons si prefieres) ---
...
const NavItem = styled.div`
  ...
  &:hover {
    ...
    transform: scale(1.1);
    color: #F7D000; /* Efecto hover dorado */
  }

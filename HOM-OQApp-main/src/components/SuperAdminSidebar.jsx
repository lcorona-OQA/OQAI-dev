  ...
  return (
    <SidebarContainer>
      ...
      <NavItems>
        ...
        {/* Metrics */}
        <NavItem
          active={location.pathname === "/admin/metrics"}
          onClick={() => navigate("/admin/metrics")}
        >
          <NavIcon src={MetricsIcon} alt="Metrics" />
          <Tooltip className="tooltip">Metrics</Tooltip>
        </NavItem>

        {/* Members (devices) */}
        <NavItem
          active={location.pathname === "/superadmin/team"}
        ...
        <NavItem
          ...
          onClick={() => {
            console.log("[Sidebar] Click en Audit Logs");
            navigate("/admin/audit-logs");
          }}
        >
          <NavIcon src={logsIcon} alt="Logs" />
          <Tooltip className="tooltip">Audit Logs</Tooltip>
        </NavItem>
      </NavItems>
      <BottomSection>
        <Profile
